...
Route::post('generateqrcode',[QrCodeController::class,'generatepdf']);
...
Route::middleware(['auth'])->prefix('vendor')->group(function ()
{
    ...
    Route::get('tables',[App\Http\Controllers\Vendor\VendorController::class,'tables']);
    ...
    Route::resource('table', Vendor\TableController::class)->except([
        'index'
    ]);

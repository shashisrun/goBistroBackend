...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <label class="form-control-label"><?php echo e(__('Item price')); ?><span class="text-danger">&nbsp;*</span></label>
                        <input class="form-control text_transform_none <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="price" type="number" min=1 placeholder="<?php echo e(__('Item Price')); ?>" id="update_price" required value="<?php echo e(old('price')); ?>">
...
<?php echo $__env->make('layouts.app',['activePage' => 'vendor_menu'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/api.gobistro.in/public_html/resources/views/admin/menu/menu.blade.php ENDPATH**/ ?>
<div class="main-sidebar" style="overflow: auto;">
    <aside id="sidebar-wrapper  p-3">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo e($activePage == 'tables' ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('vendor/tables')); ?>">
...
<?php /**PATH /home/api.gobistro.in/public_html/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>